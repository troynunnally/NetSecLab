        ...
        <div class="span3">
          <div class="well sidebar-nav">
            ...
            <ul class="nav nav-list">
              ...
              <li><a href="<?=base_url();?>index.php/repo/">Link</a></li>
              <li><a href="<?=base_url();?>index.php/repo/">Link</a></li>
              <li class="nav-header">Resources</li>
              <li><a href="<?=base_url();?>assets/files/NetSecLab_PreSurvey.pdf">NetSecLab PreSurvey</a></li>
              <li><a href="<?=base_url();?>assets/files/NetSecLab_PostSurvey.pdf">NetSecLab PostSurvey</a></li>
