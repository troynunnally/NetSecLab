  ...
  <body>
    ...
    <?php include_once('header.php'); ?>
        <div class="span9">
          ...
          <p><b>Definition</b> - The condition wherein the data transferred to a buffer exceeds the storage capacity of the buffer and some of the data "overflows" into another buffer, one that the data was not intended to go into. Since buffers can only hold a specific amount of data, when that capacity has been reached the data has to flow somewhere else, typically into another buffer, which can corrupt data that is already contained in that buffer. </p>
			<p>Malicious hackers can launch buffer overflow attacks wherein data with instructions to corrupt a system are purposely written into a file in full knowledge that the data will overflow a buffer and release the instructions into the computers instructions.</p>

<i><u>Sources:</u></i> <a href="http://www.webopedia.com/TERM/B/buffer_overflow.html" target="_blank">http://www.webopedia.com/TERM/B/buffer_overflow.html</a> <br>
<i><u>Examples:</u></i> <a href="http://www.youtube.com/watch?v=U0DISuWHXCw" target="_blank">http://www.youtube.com/watch?v=U0DISuWHXCw</a><br>
<a href="http://www.youtube.com/watch?v=MI8UTpbk1HQ" target="_blank">http://www.youtube.com/watch?v=MI8UTpbk1HQ</a><br>
