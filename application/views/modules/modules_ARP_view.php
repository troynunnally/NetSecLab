...
<html lang="en">
  ...
  <body>
    ...
    <?php include_once('header.php'); ?>
        <div class="span9">
          <h2>ARP Poisoning</h2>
          <p><b>Definition</b> - ARP spoofing is a technique whereby an attacker sends fake ("spoofed") Address Resolution Protocol (ARP) messages onto a Local Area Network. Generally, the aim is to associate the attacker's MAC address with the IP address of another host(such as the default gateway), causing any traffic meant for that IP address to be sent to the attacker instead. </p>
			<p>ARP spoofing may allow an attacker to intercept data frames on a LAN, modify the traffic, or stop the traffic altogether. Often the attack is used as an opening for other attacks, such as denial of service, man in the middle, or session hijackingattacks.The attack can only be used on networks that make use of the Address Resolution Protocol (ARP), and is limited to local network segments.</p>
...
<i><u>Sources:</u></i> <a href="http://en.wikipedia.org/wiki/ARP_spoofing" target="_blank">http://en.wikipedia.org/wiki/ARP_spoofing</a> <br>
<i><u>Examples:</u></i> <a href="http://www.youtube.com/watch?v=Yd9_HzfN-aQ" target="_blank">http://www.youtube.com/watch?v=Yd9_HzfN-aQ</a><br>
<a href="http://www.youtube.com/watch?v=VjlQny3LNlA" target="_blank">http://www.youtube.com/watch?v=VjlQny3LNlA</a><br>
